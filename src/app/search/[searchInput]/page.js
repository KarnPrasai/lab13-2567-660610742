...
export default function SearchResultPage({params}) {
  ...
  const searchtitle = String(params.searchInput);
  const processedSearchInput = searchtitle.replaceAll("%20", " ");
  /*
  ...
  */
  const filteredMovies = movieDB.filter((movie) => movie.title.toLowerCase()
